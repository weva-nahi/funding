...
urlpatterns = [
    ...
    path("<int:pk>/messages/", views.ApplicationMessageView.as_view(), name="messages"),
    # Admin
    ...
    path("admin/<int:pk>/messages/", views.ApplicationMessageView.as_view(), name="admin-messages"),
